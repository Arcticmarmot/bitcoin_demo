...
from point import Point, S256Point
...
class S256Test(TestCase):
    ...
    def test_pubpoint(self):
        ...
        for secret, x, y in points:
            ...
            self.assertEqual(secret * S256Point(Gx, Gy), point)
    ...
    def test_sec(self):
        ...
        point = coefficient * S256Point(Gx, Gy)
